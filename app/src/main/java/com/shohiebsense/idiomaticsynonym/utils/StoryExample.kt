...
object StoryExample {
    ...
    fun getTranslation() : String {
       return  "Ketika saya berangkat kerja pagi ini, mobil saya rusak, jadi saya akhirnya naik bus. Begitu saya turun, saya bertemu teman lama, Mark. Sementara kami berbicara, dia membesarkan sesuatu yang saya miliki. sudah mengetahui dari beberapa teman yang sama - bahwa dia telah mendapat uang dan telah mendirikan bisnisnya sendiri. Dia mengatakan kepada saya bahwa ada banyak hal yang harus dipilah-pilah, dan menawarkan untuk menerima saya, tetapi saya langsung menolaknya. \n "+
                "\n" +
                "Ketika saya masuk, bos saya telah pergi pada saya, mengatakan kepada saya di depan semua orang. Ketika saya mendapat kejutan awal, saya mengatakan kepadanya bahwa saya akan membuat terlambat, tapi ternyata dia telah meledak lebih dari kesepakatan yang gagal, setelah klien saya keluar dari kontrak. Dia mengatakan kepada saya bahwa saya tidak akan lolos dengan itu, bahwa saya akan mengecewakan semua orang, dan hanya terus dan terus…. \n "+
                "\n" +
