...
class IdiomCardSumarryAdapter(val idioms: List<String>, val mListener: IdiomsSummaryFragment.OnClickedItemListener) : RecyclerView.Adapter<IdiomCardSumarryAdapter.ViewHolder>() {
