...
class IdiomCardAdapter(val idioms: List<String>, val mListener: IdiomsSummaryFragment.OnClickedItemListener) : RecyclerView.Adapter<IdiomCardAdapter.ViewHolder>() {
